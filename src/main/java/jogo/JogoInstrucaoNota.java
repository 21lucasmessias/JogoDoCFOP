...
public class JogoInstrucaoNota extends JogoInstrucao {
    ...
    public void preencherPerguntas() {
        ...
        Pergunta aux = new PerguntaNotaFiscal(1, "21", "17", "11", "07100000039412", "65", "532", "136000394", "126353203", "7", "Qual é o código da UF na Chave?", respostas, 3);
    ...
    private void btnPlayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPlayMouseClicked
        JogoPerguntaNota perguntaJogo = new JogoPerguntaNota(conta, listaDePerguntas);
